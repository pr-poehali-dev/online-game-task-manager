...
def handler(event: dict, context) -> dict:
    ...
    сразу делает задачу требующей заливки в лаунчер (колонка «На лайв» или статус деплоя «Можно
    ...
    if action == 'tasks_with_files':
        ...
        # используется на доске/в разделе «На лайв», чтобы подсветить задачи, ожидающие заливки в лаунчер.

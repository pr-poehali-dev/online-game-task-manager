...
// Список залитых файлов по разделам + место на диске — переиспользуется и в FilesModal (модалка
// поверх старой страницы), и напрямую в разделе "Хранилище" кабинета (см. src/pages/Cabinet.tsx).

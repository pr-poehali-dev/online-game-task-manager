...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  file_limit_exceeded: 'Достигнут лимит количества файлов — очистите ненужные в разделе «Мои файлы» или попросите администратора увеличить лимит',
  size_limit_exceeded: 'Не хватает места: превышен лимит объёма файлов — очистите ненужные в разделе «Мои файлы» или попросите администратора увеличить лимит',

...
// Список записей журнала действий (фильтры + группировка по дням) — переиспользуется и в
// ActivityLogModal (модалка поверх старой страницы), и напрямую в разделе "Журнал" кабинета
// (см. src/pages/Cabinet.tsx), чтобы не дублировать вёрстку.

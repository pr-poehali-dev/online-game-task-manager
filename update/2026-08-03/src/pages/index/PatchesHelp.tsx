        ...
        <div className="px-4 pb-4 pt-1 border-t border-border/60 text-sm text-muted-foreground space-y-3">
          ...
          <div>
            ...
            <p>
              ...
              кнопки показывает статус: серый — не заливался (или файл с тех пор изменился и залитая
              версия больше не актуальна), оранжевый — залита именно текущая версия файла. Кнопка
              «Сверить с лаунчером» над деревом читает реальный XML-реестр на хостинге и обновляет
              статусы под факт — полезно, если файлы заливали в обход приложения (например вручную
              по FTP).
            </p>
          </div>
        </div>

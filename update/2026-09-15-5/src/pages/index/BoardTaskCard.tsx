...
export function TaskCard({
  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-semibold leading-snug mb-2.5 tracking-[-0.01em]">
        <span
          onClick={(e) => handleCopyLink(e, t.id)}
          title="Скопировать ссылку на задачу"
          className="text-muted-foreground font-normal mr-1.5 tabular-nums hover:text-primary hover:underline transition-colors"
        >
          #{t.id}
        </span>
        {t.title}

  ...
  return (
    <div className="rounded-xl border border-border bg-secondary/20 overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-border bg-card/60">
        ...
        {/* Блок кода — отдельный узел codeBlock (входит в StarterKit, уже был активен по
            горячей клавише ``` , но без кнопки). В отличие от инлайн-кода выше — своя строка
            с тёмным фоном, для логов/JSON и прочих крупных фрагментов. */}

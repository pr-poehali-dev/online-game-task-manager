...
const CODE_HINTS: Record<string, { title: string; hint: string }> = {
  ...
  // invalid_param — backend сам отклонил параметр (соотношение сторон/фон/длительность и т.п.) до
  // платного запроса, сверив его с каталогом возможностей выбранной модели (см.
  // backend/ai/common.py, _validate_media_params) — дословный текст с допустимыми значениями уже
  // в message ниже.
  invalid_param: { title: 'Параметр не подходит модели', hint: 'Точные допустимые значения — в тексте ниже.' },
};

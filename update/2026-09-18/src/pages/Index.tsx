...
export default function Index() {
  ...
  // Поиск по доске: номер задачи (#141 или просто 141) находит её точным совпадением id, любой
  // другой текст — обычным поиском по названию (см. taskMatchesSearch в sharedHelpers.ts).
  ...
  const filteredTasks = activeTasks
    ...
    .filter((t) => taskMatchesSearch(t, searchQuery));
    ...
    <div className="h-screen grid-bg text-foreground flex overflow-hidden">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        <IndexTopbar
          ...
          ideasUnreadCount={ideasUnreadCount}
        />
        ...
        <IndexMain
          ...
          reloadIdeasUnreadCount={reloadIdeasUnreadCount}

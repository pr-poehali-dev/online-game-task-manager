    ...
    <div className="flex-1 min-w-0 min-h-0 flex flex-col">
      ...
      {mode === 'image' || mode === 'video' ? (
        ...
        <AiComposer
          ...
          usage={usage}
          limitExceeded={limitExceeded}
          // Веб-поиск имеет смысл только в chat/code (см. backend/ai/generate.py,
          // handle_generate_document вообще не передаёт tools) — модель для document тоже своя,
          // выбранная в шапке "модель" к нему не относится.
          webSearch={webSearch}
          onWebSearchChange={onWebSearchChange}
          webSearchSupported={models[model]?.web_search_cost != null}
